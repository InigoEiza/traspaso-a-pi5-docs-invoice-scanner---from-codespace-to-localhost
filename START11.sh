...
echo "Abriendo puertos 4000 (backend) y 5175 (frontend) en el firewall..."
sudo ufw allow 4000/tcp >/dev/null 2>&1
sudo ufw allow 5175/tcp >/dev/null 2>&1
...
# Iniciar frontend
echo "Iniciando Frontend en puerto 5175..."
cd frontend
npm run dev &
FRONTEND_PID=$!
cd ..
...
echo ""
echo "Los puertos 4000 y 5175 ya están abiertos. Puedes acceder desde cualquier dispositivo en la misma WiFi."
